...
float gpu_utilization[2][4] = { {1} };
float mem_async_utilization[4] = {1};		// array of devices only
float total_execution_time[2][4] = { {0} };
float kernel_launch_count[2][4] = { {0} };
float total_kernel_time[2][4] = { {0} };
float non_kernel_time[2][4] = { {0} };
float sys_time[2][4] = { {0} };
float usr_time[2][4] = { {0} };
int thread_count_mem_async[2][4] = { {0} };
...
int get_next_weighted_device_async_memcpy_feedback(int app_id)
{
	...
	int chosen = 0;
	if(non_kernel_time[app_id][min] < non_kernel_time[app_id][second_min])
		chosen = second_min;
	else
		chosen = min;
...
//		gpu_utilization[row][col] = (total_kernel_time[row][col] + non_kernel_time[row][col])/ (packet->sys_time + packet->usr_time);
		gpu_utilization[row][col] = (total_kernel_time[row][col] )/ (packet->sys_time + packet->usr_time);
